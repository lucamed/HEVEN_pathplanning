...
# Parameters
SIZE = 2  # Buffer size (if a class reaches SIZE frames -> do mission)
IDLE_SIZE = 4  # Idle mode size (if no reading for IDLE frames -> reset buffer)
...
class YOLO():
    def __init__(self, db): # db is optional
        ...
        configPath = "C:\\Users\\HEVEN\\darknet\\needed_files\\yolov3-t4_tl.cfg"
        weightPath = "C:\\Users\\HEVEN\\darknet\\needed_files\\yolov3-t4_best(tl).weights"
        metaPath = "C:\\Users\\HEVEN\\darknet\\needed_files\\obj_tl.data"
    ...
    def __main(self):
        ...
        # cap = cv2.resize(cap, (HEIGHT, WEIGHT), cv2.INTER_AREA)
