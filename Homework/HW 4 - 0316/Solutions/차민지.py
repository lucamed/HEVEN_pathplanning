...
image_path1 = base_path + 'WW1.jpg'

road = cv2.imread(image_path1, 1)
y, x, _ = road.shape

# Yellow can be a tricky color to isolate in RGB space, so lets convert instead to Hue Value Saturation or HSV color space
...
cv2.line(road, (final_right_list[0], final_right_list[1]), (final_right_list[2], final_right_list[3]), (0, 0, 255), 2)
