...
3. Sums both HSV detection masks and slipt into Right and Left masks.
4. In the function drawLines, HoughLinesP is used to find lines in both masks and draw the respective color .
    ...
    Given 2 points by HoughLinesP, its calculated a 3 point with a given lenght.
...
def drawLines(line_image, mask, side):
    ...
    for line in lines_:
        for x1,y1,x2,y2 in line:
            cv2.line(lines_, (x1,y1), (x2,y2), color, 10)
